#!/bin/bash
##################################################################
#    App Name: RaspberryPi-PXE-Server                            #
#      Author:  Oleksii Tkachuk oleksii.tkachuk@unibas.ch        #
#   Publisher: Oleksii Tkachuk                                   #
...
showHeader(){
  ...
  echo -e "║───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────║"
  echo -e "║────  .~~.   .~~.   ────  ___   ─────────    __  ──────────────────  ___  _  ──────────────────────────────────────────║"
  echo -e "║──   '. \ ' ' / .'   ──  / _ \___  ___ ___  / /  ___  ___ ___ _ __  / _ \(_) ░▒▓███████▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓████████▓▒░ ─║"
  echo -e "║──    .~ .~~~..~.  ───  / , _/ _ '(_-</ _ \/ _ \/ -_) __/ __/ // / / ___/ /  ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░ ────────║"
  echo -e "║──   : .~.'~'.~. :   ─ /_/|_|\_,_/___/ .__/_.__/\__/_/ /_/  \_, / /_/  /_/   ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░ ────────║"
  echo -e "║──  ~ (   ) (   ) ~   ────────────  /_/  ────────────────  /___/  ────────── ░▒▓███████▓▒░ ░▒▓██████▓▒░░▒▓██████▓▒░ ───║"
  echo -e "║─  ( : '~'.~.'~' : )   ───────────────────────────────────────────────────── ░▒▓█▓▒░      ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░ ────────║"
  echo -e "║─   ~ .~ (   ) ~. ~    ───────────────────────────────────────────────────── ░▒▓█▓▒░      ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░ ────────║"
  echo -e "║──   (  : '~' :  )    ───────────────────────────────────────────────────────░▒▓█▓▒░      ░▒▓█▓▒░░▒▓█▓▒░▒▓████████▓▒░──║"
